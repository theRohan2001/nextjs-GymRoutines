...
const Calculator = () => {
  ...
  function calculate(weight) {
    ...
    let calculatedWeight = (weight - 20) / 2;
    const counts = { 20: 0, 15: 0, 10: 0, 7.5: 0, 5: 0, 2.5: 0 };

    // Define an array of plate weights to check
    const plateWeights = [20, 15, 10, 7.5, 5, 2.5];
        ...
        <div className="pb-20 dark:bg-black transition-colors">
          <div className="flex justify-center mt-10 pt-2">
            <div className="w-full sm:w-1/2 lg:w-1/3 text-gray-600 dark:text-gray-400">
              ...
              <p className='text-xs mt-2 mx-4 sm:mx-0'>* The weights mentioned above are for one side of a 20 kgs bar.
              </p>
            </div>
          </div>
        </div>
